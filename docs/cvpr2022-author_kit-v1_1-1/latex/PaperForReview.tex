...
%%%%%%%%% ABSTRACT
\begin{abstract}
  Pyramid Scene Parsing network (PSPNet)\cite{zhao2017pyramid} is a state-of-the-art semantic segmentation model. The key idea of this model is the Pyramid Pooling Module. The Pyramid Pooling Module calculates the global context of the image, improving the result of ResNet50\cite{he2015deep}. However, the lower layers of the Pyramid Pooling Module (2, 3, 6) layers are not utilized well. We address this problem adding minimal number of additional parameters.
\end{abstract}
